...
begin
  ...
  else if Ver = '{#VerD10T}' then Result := 'Delphi 10.2 Tokyo (BDS {#VerD10T})'
  else if Ver = '{#VerD10R}' then Result := 'Delphi 10.3 Rio (BDS {#VerD10R})'
  else if Ver = '{#VerD10Y}' then Result := 'Delphi 10.4 Sydney (BDS {#VerD10Y})'
