...
;    23.0 = Delphi 12 Athens      37.0 = Delphi 13
;
...
; Win32-only: these are RAD Studio DESIGN-TIME plugins (they require designide /
; vclie / ToolsAPI, which exist only in the 32-bit IDE). There is no Win64 BPL to
; ship - the 32-bit IDE could not load it.
