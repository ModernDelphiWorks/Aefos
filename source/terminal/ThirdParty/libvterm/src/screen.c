...
static int screen_putglyph_fn(VTermGlyphInfo *info, VTermPos pos, void *user)
{
...
static int screen_erase_fn(VTermRect rect, int selective, void *user)
{
...
static int screen_setpenattr_fn(VTermAttr attr, VTermValue *val, void *user)
{
  VTermScreen *screen = user;
...
static VTermStateCallbacks state_cbs = {
  .putglyph = &screen_putglyph_fn,
  .movecursor  = &movecursor,
  .premove     = &premove,
  .scrollrect  = &scrollrect,
  .erase = &screen_erase_fn,
  .setpenattr = &screen_setpenattr_fn,
